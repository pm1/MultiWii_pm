...
#if GYRO
  #define GYRO_SCALE (MY_GYRO_SCALE * (2380.0 * PI)/((32767.0f / 4.0f ) * 180.0f * 1000000.0f)) //should be 2279.44 but 2380 gives better result
  // +-2000/sec deg scale
...
int8_t getEstimatedAltitude(){
  ...
  //D
  BaroPID=conf.D8[PIDALT]*(LastAlt-EstAlt) / 40;
  LastAlt = (9 * LastAlt + EstAlt) / 10;
  
  //P
  BaroPID += 1L * conf.P8[PIDALT] * constrain(error,-20*conf.P8[PIDALT],20*conf.P8[PIDALT]) /100;
