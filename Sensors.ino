...
#define OSS 3 //we can get more unique samples and get better precision using average
...
void  Baro_init() {
  ...
  delay(5);
  i2c_BMP085_UT_Read();
  bmp085_ctx.temp = bmp085_ctx.ut.val; 
}
